        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="<?= base_url('Asset/img/bg2.jpg') ?>" alt="" class="img-event position-relative mx-auto">
                        </div>
                        <h3>Malang</h3>
                    </div>
                </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="<?= base_url('Asset/img/bg4.jpg') ?>" alt="" class="img-event position-relative mx-auto">
                        </div>
                        <h3>Bandung</h3>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-layanan">
                        <div class="circle-icon position-relative mx-auto">
                            <img src="<?= base_url('Asset/img/bg3.jpg') ?>" alt="" class="img-event position-relative mx-auto">
                        </div>
                        <h3>Jakarta</h3>
                    </div>
                </div>
